...
app.listen(PORT, () => {
    console.log(`\n🚀 Memory API server running on port ${PORT}`);
    ...
    console.log(`- GET  /memory/scheduler/status`);
    console.log(`- POST /memory/scheduler/trigger`);
    console.log(`- GET  /memory/pool/health`);
    console.log(`- POST /memory/culture-card`);
    console.log(`- POST /memory/gap-analysis`);
