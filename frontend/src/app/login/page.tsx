    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass-panel rounded-2xl p-8 max-w-md w-full z-10 relative">
        ...
        <div className="space-y-4">
          <Link href="/dashboard" className="w-full flex items-center justify-center gap-3 bg-white text-black py-3 px-4 rounded-xl font-medium hover:bg-gray-100 transition-colors">
          ...
          <div className="text-center mt-6">
            <p className="text-xs text-gray-500 font-mono">
              [ Mock authentication for hackathon prep ]<br/>
              Ready for Supabase OAuth drop-in
            </p>
          </div>
        </div>
      </div>
